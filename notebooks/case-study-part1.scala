...
val configs = Map(
  ...
  "fs.azure.account.oauth2.client.id" -> "028c12a2-90bc-4213-b710-695f20802d9b",
...
dbutils.fs.mount(
  source = "abfss://data@iomegadlsgen2source.dfs.core.windows.net/",
  mountPoint = "/mnt/data",
...
object SentimentDetector extends Serializable {
    val accessKey = "9be54e8612ec46119b7fa5174e429d6b"
